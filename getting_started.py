...
if __name__ == "__main__":
    ...
    dm.load_db()
    for x in range(10):
        c = dm.new_connection({"connection_type": "base", "description": "fred's connection"})
    ...
    for conn_id, conn_obj in dm.get("connections").items():
        ...
        for x in range(10):
            conn_obj.new_tag({"connection_id": conn_id, "description": f"Blah Blah {1+x}", "value":x*100.0 })
